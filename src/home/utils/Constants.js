export const socialNetworks = {
    'github':'https://github.com/alf0ns0-l0pez',
    'linkedin':'https://www.linkedin.com/in/alfonsolopezobando/',
    'twitter':'https://twitter.com/alf0ns0l0pez',
    'youtube':'https://youtube.com/@ALFONSO_FPV',
    'grabcad':'https://grabcad.com/alfonso.lopez-40'
}
export const tradeMindProjectContent = {
    "title":"Trade Mind - Web Page",
    "details":<p>This project has a web page where any enthusiast of Crypto Trading be able to visualize stats which count 
    ...
    "resources":[
        ...
        {
            "field":"CSS Library",
            "values":"React Google Charts, Tradingview Lightweight Charts, Material UI"
        },
        {
            "field":"Backend",
            "values":"Javascrypt - Express, Socket IO"
        },
        {
            "field":"Data Colector",
            "values":"Python - SQLAlchemy , Requests"
        },
        {
            "field":"Database",
            "values":"PostgreSQL"
        },
        {
            ...
            "values":"Rocky Linux (CLOUD)"
        },
        {
            "field":"Deployment",
            "values":"Docker, Docker Compose"
        },
    ],
...
export const minerMonitorProjectContent = {
    ...
    "details":<p>This is BETA webpage created to manage every Minerpunk Board which you can see in detail below this project, 
